...
bool PhysicsEngineApp::startup() 
{
	...
	m_sphere1 = new AABB(glm::vec2(30.0f, -20.0f), glm::vec2(2.0f, 3.0f), glm::vec2(0.0f, 0.0f), 0.0f, 10.0f, false);
	//m_sphere2 = new AABB(glm::vec2(30.0f, -40.0f), glm::vec2(2.0f, 3.0f), glm::vec2(0.0f, 0.0f), 0.0f, 10.0f, true);
	//Sphere(glm::vec2(30.0f, 0.0f), glm::vec2(0.0f, 0.0f), 5.0f, 4.0f, glm::vec4(1.0f, 1.0f, 0.0f, 1.0f), false);
