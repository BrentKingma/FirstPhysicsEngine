...
bool Application3D::startup() {
	...
	m_gameObject = new GameObject(nullptr, true, { 5, 5, 5 }, true, ColliderType::AABB, { 2, 2, 2 });
...
void Application3D::draw() {
	...
	// draw 3D gizmos
	//Gizmos::addSphere(m_gameObject->GetPosition(), 2, 5, 5, { 1, 0, 0, 0 }, m_gameObject->GetMatrix());
	m_gameObject->GetCollider()->debug();
	m_gameObject->GetBoundingBox()->debug();
